...
---
As discussed in the previous chapter, marketing data are valuable pieces of information about the program that helps in acquiring clients. These include Video URL, Program Description, What you will learn, and Coach Info section. 
...
This will help the users who are new to the coaching platform, understand the therapies before signing up for the program.

**2. Description**

The description is used for stating the objective of a program in one or two lines. Going by the above example, if your program is “DBT Skills Training”, then the description can be something like-
...
If you have searched for the perfect class and still haven’t found one, try no more. DBT classes will give you the flexibility you have been looking, for while making it easy and fun to learn DBT skills.
